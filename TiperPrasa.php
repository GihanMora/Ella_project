...
<html>
	...
	<form method="post" action="TiperPrasa.php" align="left">
		...
		<div class='head'>
		<h2 align='center' color="black"> ඇල්ල ප්‍රාදේශීය සභාව ටිපර් රථය කුලියට ගැනීම </h2>
	...
	if(isset($_POST['sub'])){
		...
		<tr>
			...
			$select="select * from tiper_owners where PayDate='$date'";
		...
		echo '<form method ="post" action ="TiperPrasa.php" align="left">
			...
			echo '<h2 color="black"> මෙම අවුරුද්දට අදාළ අත්තිකාරම් ගෙවීම් තොරතුරු</h2>';
		...
		echo '<tr>
			...
			$advancetotal=$jan+$feb+$mar+$april+$may+$june+$july+$aug+$sep+$oct+$nov+$dec;
				...
				echo '<h2 color="black"> මෙම අවුරුද්දට අදාළ හිඟ  ගෙවීම් තොරතුරු</h2>';
		...
		echo 'මුළු මුදල රු '.$finaltotal.'.00/=</p>';
			...
			echo '<form method ="post" action ="TiperPrasa.php">
