...
<h4 align='center'>-ව්‍යාපාර බලපත්‍ර-වාර්තාව</h4>
	...
	<form id='ttt' action='wyapara_table-2.php' method='post'>
...
$query = "SELECT ankaya,balapathra_ankaya,nama,address,idiri_ge_she,warshika_gasthuwa,
				...
				COALESCE(jan,0) + COALESCE(feb,0) + COALESCE(mar,0) + COALESCE(april,0) + COALESCE(may,0)+ COALESCE(june,0)+ COALESCE(july,0)+ COALESCE(sep,0)+ COALESCE(oct,0)+ COALESCE(nov,0)+ COALESCE(december,0) AS 'Total',idiri_genaa_sheshaya FROM balapathra_wyapara where year='$yrs'"; 
