	...
	<div id='tab2' style="display:block;" >
		...
		<?php
			...
			if(isset($_POST['set'])){
				...
				$dys=$_POST['day'];
				$fd="$yrs-$mas-$dys";
				$select1= "SELECT ankaya,balapathra_ankaya,nama,address,ekathuwa,masaya,sub_date,sub_time FROM balapathra_wyapara_short where sub_date='$fd'"; 
		...
		elseif(isset($_POST['search'])){
			$nm=$_POST['sb'];
			$select="select ankaya,balapathra_ankaya,nama,address,ekathuwa,masaya,sub_date,sub_time from balapathra_wyapara_short where nama like'%$nm%'";
