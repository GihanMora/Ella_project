...
<nav><ul>
	...
	<div id='tab3' style="display:block;" >
		<form action='rawananarabumtable.php' method='post'>
		...
		<?php
			...
			if(isset($_POST['set'])){
				...
				$dys=$_POST['day'];
				$fd="$yrs-$mas-$dys";
				$query1 = "SELECT ankaya,date,masaya,masikaMudala,geviyaYuthuMudala,geweema,adhi,higa,sub_date,sub_time FROM rawananarabum where sub_date='$fd'"; 
			...
			$query = "SELECT ankaya,date,masaya,masikaMudala,geviyaYuthuMudala,geweema,adhi,higa,sub_date,sub_time FROM rawananarabum"; 
	...
	if(isset($_POST['search'])){
		$nm=$_POST['sb'];
		$select="SELECT ankaya,date,masaya,masikaMudala,geviyaYuthuMudala,geweema,adhi,higa,sub_date,sub_time FROM rawananarabum where date like'%$nm%'";
	...
	<div id='search'>
		...
		<a href="rawananarabumtable.php" target="_self"  style="text-decoration:none;" >
		<input class="expand" type="button" name="regbutton" value="මුද්‍රණය කරන්න.">
		</a>
		</td></tr>
		<tr>
		<td align='center' colspan='1'>
		<a href="rawanaella.php" target="_self"  style="text-decoration:none;" >
