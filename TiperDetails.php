...
?>
	...
	<html>
		...
		if ($availability==0){
			///echo '<h1> ටිපර්රථය කුලියට දීමට ඇත.</h1>';
			...
			$sel2="select * from tiper_users WHERE ID = '$id'";
			...
			if($check2>0){
				...
				<p><a href='TiperPaymentDetails.php?run_value=<?php echo $share ?>'>  රථය ලබා ගැනීම සම්බන්ද තොරතුරු    </a></p>
				<?php
				...
				echo '<h1>අනන්‍යතාවය තහවුරු නැත </h2><br/>
							<h2><a href= "TiperRegister.php"> නව සාමජිකත්වය<a/></h2></br>	';
				}
			}
			...
			echo '<h1> ටිපර් රථය කුලියට දීමට නොමැත.<br/>අවසානයට කුලියට ගත් පුද්ගල තොරතුරු. </h1><h3>';
