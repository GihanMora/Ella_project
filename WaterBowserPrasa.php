...
<html>
	...
	<form method="post" action="WaterBowserPrasa.php" align="left">
	...
	if(isset($_POST['sub'])){
		...
		<tr>
			...
			$select="select * from water_bowser_owners where PayDate='$date'";
		...
		echo '<form method ="post" action ="WaterBowserPrasa.php" align="left">
		...
		echo 'මුළු මුදල රු'.$finaltotal.'.00/=</p>';
			...
			echo '<form method ="post" action ="WaterBowserPrasa.php">
