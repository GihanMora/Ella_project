...
<body class='body'>
	...
	<div id='tab2' style="display:block;" >
		<form action='sathipolatable.php' method='post'>
	...
	<div id='tab2' style="display:block;" >
		<?php
			...
			if(isset($_POST['set'])){
				...
				$dys=$_POST['day'];
				$fd="$yrs-$mas-$dys";
				$query1 = "SELECT ankaya,date,masaya,masikaMudala,geviyaYuthuMudala,geweema,adhi,higa,sub_date,sub_time FROM sathipola where sub_date='$fd'"; 
			...
			echo "</table>"; //Close the table in HTML
				...
				$query = "SELECT ankaya,date,masaya,masikaMudala,geviyaYuthuMudala,geweema,adhi,higa,sub_date,sub_time FROM sathipola"; 
	...
	<div id='search'>
		...
		<tr>
		<td align='center' colspan='1'>
		<a href="sathipola.php" target="_self"  style="text-decoration:none;" >
