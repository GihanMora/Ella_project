...
<body class='body'>
	...
	<a href="shop_info.php" target="_self"  style="text-decoration:none;" target="_blank"><input  type='button' class='see' name='button' value='බලපත්‍ර ලියාපදිංචි ලේඛණය.'></a>
	...
	<form action='kadakuli.php' method='post' >
			...
			<tr><td align='center'><b>කඩකුලී ඇතුලත් කිරීම</b></td></tr>
				...
				<tr><td>ගාස්තුව:<input type='text' name='payment2' required='true' placeholder='ගාස්තුව'></td></tr>
