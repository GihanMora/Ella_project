...
<body class='body'>
	...
	/*	if(isset($_POST['search'])){
			...
			echo "<table id='tables'>"; // start a table tag in the HTML
			echo "Filtered Results:";
			echo "<tr><td class='cages'>අංකය</td><td class='cages'>ලියාපදිංචි  අංකය</td><td class='cages'>නම </td><td class='cages'>කඩහිමියාගේ නම</td><td class='cages'>එකතුව</td><td class='cages'>මාසය</td></tr>";
			while($res = mysqli_fetch_array($dets)){   //fetches a row as an associatinve array
