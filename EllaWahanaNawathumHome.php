...
<html>
	...
	<body>
	<form method="post" action="EllaWahanaNawathumHome.php" align="left">
	...
	<h1> මුදල් විස්තර ඇතුලත් කිරීම </h1>
	...
	<form method ="post" action ="EllaWahanaNawathumHome.php">
	...
	header("location:EllaWahanaNawathumPrasa.php");
	exit;
	}?>
