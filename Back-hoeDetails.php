...
?>
	...
	<html>
		...
		<body>
			<form method="post" action="Back-hoeDetails.php" align="left">
		...
		<h2 align=center>බැකෝ රථය කුලියට දීමට ඇත.</h2>
		<h2 align=center> බැකෝ රථය ලබා ගැනීම සදහා විස්තර  ඇතුලත් කිරීම  </h2>
	...
	<form method ="post" action ="Back-hoeDetails.php"></br>
		...
		$section="බැකෝ රථය අත්තිකාරම් මුදල් ගෙවීම";
		...
		$true=1;
		$false=0;
		$insert1="insert into back_hoe_owners(Name,ID,Address,TP,DoP,DoS,Advance,Total,PayDate,Remainder,AdvancePaid) values('$name','$id','$address','$telephone','$dop','$dos','$advance','$total','$dop','$remainder','$true')";
		$insert2="update back_hoe_availability set Availability=$false where BNumber='B1'";
		$insert3="insert into prasa_two(vistharaya,geweema,Approved,wargaya) values ('$description','$advance','false','$section')";
		...
		mysqli_close($con);
			...
			echo '<h2 align=center> බැකෝ රථය කුලියට දීමට නොමැත</h2><br/><p align="center">අවසානයට කුලියට ගත් පුද්ගල තොරතුරු</p>';
